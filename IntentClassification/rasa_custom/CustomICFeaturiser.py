...
class IntentClassificationFeaturizer(DenseFeaturizer):
    ...
    defaults = {
        # Specify what pooling operation should be used to calculate the
        # vector of the CLS token. Available options: 'mean' and 'max'
    ...
    def _get_doc(self, message: Message, attribute: Text) -> Any:
        ...
        """
        return message.get(DENSE_FEATURE_NAMES[attribute])
